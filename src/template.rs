...
use crate::aes_tool::{aes_enc_ecb_string, aes_enc_cbc_string, aes_enc_ctr_string, aes_dec_ecb_string, aes_dec_cbc_string, aes_dec_ctr_string};
...
fn to_int(_state: &State<'_, '_>, value: String) -> Result<i32, Error> {
    value.parse::<i32>().map_err(|_e|Error::new(ErrorKind::InvalidArguments, format!("{}cant turn to int", value)))
}
